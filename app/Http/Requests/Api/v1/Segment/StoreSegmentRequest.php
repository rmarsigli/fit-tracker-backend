...
class StoreSegmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['required', 'string', Rule::enum(SegmentType::class)],
            'distance_meters' => ['required', 'numeric', 'min:50', 'max:100000'],
    ...
    public function messages(): array
    {
        return [
            ...
            'route.required' => 'Rota (LineString) é obrigatória',
        ];
    }
}
